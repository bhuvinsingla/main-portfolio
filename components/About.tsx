        ...
        <div className="glass shape-card shape-about card-glass p-8 md:p-10">
          <div className="flex flex-col sm:flex-row gap-8 mb-8 items-center sm:items-start">
            ...
            <div className="space-y-2 text-center sm:text-left">
              <p className="text-lg font-semibold text-zinc-50">{PERSONAL_INFO.name}</p>
              <p className="text-zinc-400">{PERSONAL_INFO.role} · {PERSONAL_INFO.location}</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-zinc-50 mb-4">Tech Stack</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="space-y-1">
                  ...
                  <p className="text-zinc-300 text-sm">{items}</p>
                </div>
              ))}
            </div>
          </div>
