...
const Pill: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <span className="px-2 py-1 rounded-full border border-zinc-200/80 bg-zinc-50 text-[11px] text-zinc-600">
    {children}
  </span>
);
    ...
    >
      <div className="grid lg:grid-cols-3 gap-8">
        <Reveal className="lg:col-span-1 space-y-5" delay={0}>
          <div className="inline-flex items-center gap-2 glass rounded-full px-3 py-1 text-xs font-mono uppercase tracking-widest text-brand-600">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-zinc-600">
              <li>• <span className="text-zinc-800 font-medium">Humanize</span> - natural tone, turn‑taking, graceful fallbacks.</li>
              <li>• <span className="text-zinc-800 font-medium">Latency obsessed</span> - streaming, pre‑warming, minimal round‑trips.</li>
              <li>• <span className="text-zinc-800 font-medium">Efficient prompts</span> - structured tools, predictable costs.</li>
              <li>• <span className="text-zinc-800 font-medium">Task‑first flows</span> - goal‑driven conversations.</li>
            </ul>
          </div>
        </Reveal>
        ...
        <Reveal className="space-y-4" delay={100}>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-semibold text-zinc-800 uppercase tracking-wide">LLMs · STT · TTS</h3>
          </div>
          {[
            ['LLMs', llms],
          ...
          <div className="glass shape-card shape-expertise p-4 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold text-zinc-700 uppercase tracking-wide">RAG &amp; flows</p>
            </div>
        ...
        <Reveal className="space-y-5" delay={200}>
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-zinc-800 uppercase tracking-wide">Platforms &amp; tools</h3>
            </div>
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={tool.name} className="glass shape-card shape-social flex items-center gap-2 px-3 py-2">
                  ...
                  <span className="text-xs text-zinc-600">{tool.name}</span>
                </div>
              ))}
            </div>
          </div>
