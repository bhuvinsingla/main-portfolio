  ...
  return (
    <Section id="story" title="My Story" subtitle="Who I am, what I feel, and the journey that shaped me—with a few proverbs along the way.">
      <div className="max-w-5xl mx-auto space-y-24">
        ...
        {/* Proverb intro */}
        <blockquote className="text-center border-l-0">
          <Quote className="w-10 h-10 text-brand-500/60 mx-auto mb-4" />
          <p className="text-xl md:text-2xl text-slate-300 italic font-medium max-w-3xl mx-auto">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex items-center justify-center w-12 h-12 rounded-xl bg-brand-500/20 text-brand-400 border border-brand-500/30">
              <BookOpen className="w-6 h-6" />
            </span>
            <div>
              <h3 className="text-2xl font-bold text-white">Chapter 1 — It&apos;s All About Salesforce</h3>
              <p className="text-slate-400 text-sm">Where I learned that CRM isn&apos;t just data—it&apos;s people and process.</p>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-2">
              <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-slate-500">Salesforce (Trailhead)</p>
              <p className="text-slate-200 text-sm font-semibold">Tagline: The #1 AI CRM — We bring companies and customers together.</p>
              <p className="text-slate-300 text-sm">
                <span className="font-semibold text-slate-200">What the company deals with:</span>{' '}
                Cloud CRM platform, automation, analytics, and customer 360 solutions.
              </p>
              <p className="text-slate-300 text-sm">
                <span className="font-semibold text-slate-200">Tech I learned:</span>{' '}
                Salesforce CRM, data modelling, automation with flows, and building apps on the Salesforce platform.
              </p>
            </div>
            <div className="bg-slate-800/40 border border-slate-700 rounded-xl p-4 flex items-center">
              <p className="text-slate-300 text-sm italic">
                “A journey of a thousand miles begins with a single step.”<br />
                <span className="text-slate-400 text-xs">Trailhead was that first step for me.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4 min-w-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-4 min-w-0">
                <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-brand-400 font-bold text-sm sm:text-base truncate" title={TRAILHEAD.rank}>{TRAILHEAD.rank}</p>
                  <p className="text-slate-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Rank</p>
                </div>
                <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-white font-bold text-sm sm:text-lg">{TRAILHEAD.badges}</p>
                  <p className="text-slate-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Badges</p>
                </div>
                <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-white font-bold text-xs sm:text-lg truncate" title={TRAILHEAD.points.toLocaleString()}>{TRAILHEAD.points.toLocaleString()}</p>
                  <p className="text-slate-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Points</p>
                </div>
                <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-white font-bold text-sm sm:text-lg">{TRAILHEAD.trails}</p>
                  <p className="text-slate-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Trails</p>
                </div>
              </div>
            </div>
          ...
          {/* <div className="mt-4 flex gap-4 overflow-x-auto pb-2">
            {[
              ...
              <img
                ...
                src={img.src}
                alt={img.alt}
                className="h-24 w-32 object-contain p-2 rounded-lg border border-slate-700 bg-slate-800/40 flex-shrink-0"
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex items-center justify-center w-12 h-12 rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
              <Mountain className="w-6 h-6" />
            </span>
            <div>
              <h3 className="text-2xl font-bold text-white">Chapter 2 — Antier Solutions & the Blockchain Boom</h3>
              <p className="text-slate-400 text-sm">When the trend was blockchain, I jumped in. And I learned that the real asset was teamwork.</p>
              <p className="text-slate-500 text-xs mt-1">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-2">
              <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-slate-500">Antier Solutions</p>
              <p className="text-slate-200 text-sm font-semibold">Tagline: Decentralizing the world.</p>
              <p className="text-slate-300 text-sm">
                <span className="font-semibold text-slate-200">What the company deals with:</span>{' '}
            ...
            <div className="bg-slate-800/40 border border-slate-700 rounded-xl p-4 flex items-center">
              <p className="text-slate-300 text-sm italic">
                ...
                <span className="text-slate-400 text-xs">Antier taught me how far a strong team can go.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex flex-col gap-3">
                {['User / DApp', 'Web3 (ethers.js)', 'Smart contract', 'Chain'].map((step, i) => (
                  <div key={step} className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-brand-500/20 text-brand-400 flex items-center justify-center text-sm font-mono">{i + 1}</div>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-700 bg-slate-800/50 aspect-video flex items-center justify-center">
              ...
              />
              <div className="hidden absolute inset-0 flex items-center justify-center bg-slate-800/90 text-slate-500 text-sm">
                Image: <code className="text-slate-400">public/pics/antier-solutions.avif</code>
              </div>
            </div>
          </div>
          {/* <div className="mt-4 flex gap-4 overflow-x-auto pb-2">
            {[
              ...
              <img
                ...
                src={img.src}
                alt={img.alt}
                className="h-24 w-32 object-cover rounded-lg border border-slate-700 flex-shrink-0"
                onError={(e) => ((e.target as HTMLImageElement).style.display = 'none')}
              />
            ))}
          </div> */}
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex items-center justify-center w-12 h-12 rounded-xl bg-amber-500/20 text-amber-400 border border-amber-500/30">
              <Sparkles className="w-6 h-6" />
            </span>
            <div>
              <h3 className="text-2xl font-bold text-white">Chapter 3 — The Dream Come True</h3>
              <p className="text-slate-400 text-sm">The company where I came as a noob—and learned I could handle anything.</p>
              <p className="text-slate-500 text-xs mt-1">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-2">
              <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-slate-500">SmartData Enterprises Inc.</p>
              <p className="text-slate-200 text-sm font-semibold">Tagline: Scaling Expectations — AI-driven, outcome-focused, human-centric.</p>
              <p className="text-slate-300 text-sm">
                <span className="font-semibold text-slate-200">What the company deals with:</span>{' '}
            ...
            <div className="bg-slate-800/40 border border-slate-700 rounded-xl p-4 flex items-center">
              <p className="text-slate-300 text-sm italic">
                ...
                <span className="text-slate-400 text-xs">SmartData is where I proved that courage every day.</span>
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="relative rounded-2xl overflow-hidden border border-slate-700 bg-slate-800/50 aspect-video flex items-center justify-center">
              ...
              />
              <div className="hidden absolute inset-0 flex items-center justify-center bg-slate-800/90 text-slate-500 text-sm">
                Image: <code className="text-slate-400">public/pics/SmartData.jpg</code>
              </div>
            </div>
            <div className="mt-4 flex gap-4 overflow-x-auto pb-2">
          ...
          <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-8 md:p-10 space-y-6">
            <p className="text-slate-300 leading-relaxed">
        ...
        <div className="text-center py-8">
          <p className="text-slate-400 text-lg max-w-2xl mx-auto flex items-center justify-center gap-2 flex-wrap">
