    ...
    <Section index="02" id="story" title="My Story" subtitle="Who I am, what I feel, and the journey that shaped me-with a few proverbs along the way.">
      <div className="max-w-5xl mx-auto space-y-24">
        ...
        <blockquote className="text-center border-l-0 glass shape-card shape-story-quote p-8 mb-4">
          ...
          <p className="text-xl md:text-2xl text-zinc-600 italic font-medium max-w-3xl mx-auto">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex items-center justify-center w-12 h-12 rounded-xl bg-brand-500/15 text-brand-600 border border-brand-500/30">
              <BookOpen className="w-6 h-6" />
            </span>
            <div>
              <h3 className="text-2xl font-bold text-zinc-900">Chapter 1 - It&apos;s All About Salesforce</h3>
              <p className="text-zinc-500 text-sm">Where I learned that CRM isn&apos;t just data-it&apos;s people and process.</p>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 glass shape-card shape-story-block p-4 space-y-2">
              ...
              <p className="text-zinc-700 text-sm font-semibold">Tagline: The #1 AI CRM - We bring companies and customers together.</p>
              <p className="text-zinc-600 text-sm">
                <span className="font-semibold text-zinc-700">What the company deals with:</span>{' '}
                Cloud CRM platform, automation, analytics, and customer 360 solutions.
              </p>
              <p className="text-zinc-600 text-sm">
                <span className="font-semibold text-zinc-700">Tech I learned:</span>{' '}
            ...
            <div className="glass shape-card shape-story-block p-4 flex items-center">
              <p className="text-zinc-600 text-sm italic">
                ...
                <span className="text-zinc-500 text-xs">Trailhead was that first step for me.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4 min-w-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-4 min-w-0">
                ...
                <div className="glass shape-card shape-story-stat p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-zinc-900 font-bold text-sm sm:text-lg">{TRAILHEAD.badges}</p>
                  <p className="text-zinc-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Badges</p>
                </div>
                <div className="glass shape-card shape-story-stat p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-zinc-900 font-bold text-xs sm:text-lg truncate" title={TRAILHEAD.points.toLocaleString()}>{TRAILHEAD.points.toLocaleString()}</p>
                  <p className="text-zinc-500 text-[10px] sm:text-xs uppercase tracking-wider mt-1">Points</p>
                </div>
                <div className="glass shape-card shape-story-stat p-3 sm:p-4 text-center min-w-0 overflow-hidden">
                  <p className="text-zinc-900 font-bold text-sm sm:text-lg">{TRAILHEAD.trails}</p>
            ...
            <div className="relative glass shape-card shape-story-media aspect-video flex items-center justify-center overflow-hidden">
              ...
              />
              <div className="hidden absolute inset-0 flex items-center justify-center bg-zinc-100 text-zinc-500 text-sm">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h3 className="text-2xl font-bold text-zinc-900">Chapter 2 - Antier Solutions & the Blockchain Boom</h3>
              <p className="text-zinc-500 text-sm">When the trend was blockchain, I jumped in. And I learned that the real asset was teamwork.</p>
              <p className="text-zinc-500 text-xs mt-1">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 glass shape-card shape-story-block p-4 space-y-2">
              ...
              <p className="text-zinc-700 text-sm font-semibold">Tagline: Decentralizing the world.</p>
              <p className="text-zinc-600 text-sm">
                <span className="font-semibold text-zinc-700">What the company deals with:</span>{' '}
            ...
            <div className="glass shape-card shape-story-block p-4 flex items-center">
              <p className="text-zinc-600 text-sm italic">
                ...
                <span className="text-zinc-500 text-xs">Antier taught me how far a strong team can go.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex flex-col gap-3">
                {['User / DApp', 'Web3 (ethers.js)', 'Smart contract', 'Chain'].map((step, i) => (
                  <div key={step} className="flex items-center gap-3">
                    ...
                    <span className="text-zinc-600 text-sm">{step}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="relative glass shape-card shape-story-media aspect-video flex items-center justify-center overflow-hidden">
              ...
              />
              <div className="hidden absolute inset-0 flex items-center justify-center bg-zinc-100 text-zinc-500 text-sm">
                Image: <code className="text-zinc-500">public/pics/antier-solutions.avif</code>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            <span className="flex items-center justify-center w-12 h-12 rounded-xl bg-zinc-100 text-zinc-600 border border-zinc-200/80">
              <Sparkles className="w-6 h-6" />
            </span>
            <div>
              <h3 className="text-2xl font-bold text-zinc-900">Chapter 3 - The Dream Come True</h3>
              <p className="text-zinc-500 text-sm">The company where I came as a noob-and learned I could handle anything.</p>
              <p className="text-zinc-500 text-xs mt-1">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="md:col-span-2 glass shape-card shape-story-block p-4 space-y-2">
              ...
              <p className="text-zinc-700 text-sm font-semibold">Tagline: Scaling Expectations - AI-driven, outcome-focused, human-centric.</p>
              <p className="text-zinc-600 text-sm">
                <span className="font-semibold text-zinc-700">What the company deals with:</span>{' '}
            ...
            <div className="glass shape-card shape-story-block p-4 flex items-center">
              <p className="text-zinc-600 text-sm italic">
                ...
                <span className="text-zinc-500 text-xs">SmartData is where I proved that courage every day.</span>
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="relative glass shape-card shape-story-media aspect-video flex items-center justify-center overflow-hidden">
              ...
              />
              <div className="hidden absolute inset-0 flex items-center justify-center bg-zinc-100 text-zinc-500 text-sm">
                Image: <code className="text-zinc-500">public/pics/SmartData.jpg</code>
              </div>
            </div>
          </div>
        ...
        <div className="text-center py-8">
          <p className="text-zinc-500 text-lg max-w-2xl mx-auto flex items-center justify-center gap-2 flex-wrap">
